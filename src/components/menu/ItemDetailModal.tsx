...
// 1. O'ZGARISH: Asosiy turni import qilib, uni kengaytiramiz (TS xatosi uchun FIX)
import { MenuItem as BaseMenuItem } from "@/lib/types";
import { cn } from "@/lib/utils";
import Image from "next/image";
import { X, ChefHat } from "lucide-react";

// TS xatosi bermasligi uchun turni shu yerning o'zida yangilaymiz
    ...
    >
      ...
      >
        ...
        <div className="relative px-6 pb-10 -mt-6 z-10">
          ...
          {!item.isAvailable && (
            <p className="text-[10px] bg-red-500/10 text-red-500 font-bold uppercase tracking-widest px-3 py-2 rounded-lg mb-4 text-center inline-block">Hozir Yopiq</p>
          )}
